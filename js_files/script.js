$(document).ready(function(){
	...
	var Tabs = {
	    'My Profile'	: 'pages/home.html',
		'My Books'	: 'pages/entertainment.html',
		'Add Books'	: 'php_files/booksform.php',
		'Schedule'	: 'pages/social.html',
		'other User'	: 'pages/computer.html',
		'Mail'	: 'pages/travels.html',
		'Logout' : 'php_files/logout.php'
	}
	...
	$.each(Tabs,function(i,j){
		...
		var tmp = $('<li><a href="#" title= "Click me!" class="tab '+colors[(z++%1)]+'">'+i+' <span class="left" /><span class="right" /></a></li>');
